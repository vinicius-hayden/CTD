...
form.addEventListener("submit", (e) => {
  ...
  function signup() { 
    if (validUser && validEmail && validSenha) { 
      // Pick up Local Storage
      let userList = JSON.parse(localStorage.getItem('userList') || '[]'); // Won't exist in the first place, therefore an empty array will be created instead.
      userList.push( // If null, userList will be pushed
        { 
          username: nome.value,
      ...
      // Local Storage data insert, with two parameter as always.
